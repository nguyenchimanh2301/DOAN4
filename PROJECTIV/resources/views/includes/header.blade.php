<div class="header-section">
                    ...
                    <div class="logo">
                        <a href="index.html">
                            <span class="logo-img">
                                <img src="Admin/assets/images/logo_sm.png" alt="" height="26">
                            </span>
                            <!--<i class="fa fa-maxcdn"></i>-->
                            <span class="brand-name">NCM</span>
                        </a>
                    </div>
                        ...
                        <ul class="nav navbar-nav">                           
                            ...
                            <li>
                                <form class="search-content" action="index.html" method="post">
                                    <input type="text" class="form-control mt-3" name="keyword" placeholder="Search..." ng-model="search">
                            ...
                            <ul class="notification-menu">
                                    ...
                                    <ul class="dropdown-menu mailbox dropdown-menu-right">
                                        ...
                                        <li class="notification-scroll">
                                            <div class="message-center">
                                                <a href="#">
                                                    <div class="user-img">
                                                         <img src="Admin/assets/images/users/avatar-2.jpg" alt="user" class="rounded-circle"> 
                                                ...
                                                <a href="#">
                                                    <div class="user-img">
                                                        <img src="Admin/assets/images/users/avatar-3.jpg" alt="user" class="rounded-circle"> 
                                                ...
                                                <a href="#">
                                                    <div class="user-img">
                                                        <img src="Admin/assets/images/users/avatar-4.jpg" alt="user" class="rounded-circle"> 
                                                ...
                                                <a href="#">
                                                    <div class="user-img"> 
                                                        <img src="Admin/assets/images/users/avatar-5.jpg" alt="user" class="rounded-circle"> 
                                ...
                                <li>
                                    <a href="javascript:;" data-toggle="dropdown">
                                        <img src="/upload/images/admin.jpg" alt="">
                                    </a>
