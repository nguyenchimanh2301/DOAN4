...
@section('content')
    ...
    <table class="table table-bordered">
        ...
        <tbody>
        <tr dir-paginate = "sp in cnhap |filter: search| itemsPerPage: pageSize" current-page="currentPage">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control" id="name" ng-model="cbans.id">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 col-form-label">Id bill</label>
                            <div class="col-sm-9">

                                <input type="text" class="form-control" id="name" ng-model="cbans.id_bill_nhap">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" ng-model="cbans.don_vi">
                            </div>
                        </div>
                        <div class="form-group row">
